import { CardTimelineProps } from '.'

export default [
  {
    title: 'O início',
    content: `<p>Desde de muito cedo sempre gostei muito de tecnologia,
    como video game, computador, celular,
    mais nunca tinha tido interesse de querer saber como tudo aquilo funcionava.</p>
    <p>Meu primeiro contato com programação,
    foi durante o curso onde me formei Técnico em Informática pelo Senac.</p>
    <p>Foi algo mágico, eu digo que foi “amor a primeira linha de código”,
    eu me apaixonei por como tudo aquilo funcionava,  como cada tag fazia algo diferente,
    como a gente podia transformar o visual de um documento HTML, com a adição do CSS.
    Eu fiquei maravilhado todo aquele mundo e
    a infinidade de possibilidades que eu tinha descoberto.</p>
    `,
  },
  {
    title: 'InFome',
    content: `<p>Durante o curso, participei de alguns projetos com meus colegas,
    o principal deles foi a criação do InFome,
    um projeto com a ideia de divulgar lugares pouco conhecidos da cidade,
    mostrando informações, imagens, localizção,
    incentivando o usuário ir até o lugar divulgado.</p>
    <p>O projeto chegou a ser pré-incubado pela ITUNISC,
    que incentiva micro e pequenas empresas tecnologicamente inovadoras.</p>
    <p>Fui responsável por todo o desenvolvimento da aplicação,
    backend e frontend, junto com a cordenação do meu professor.</p>
    <p>Infelizmente o projeto não foi em frente,
    mais todo o aprendizado e vivência que tive, foi algo que me agregou muito.</p>
    `,
  },
  {
